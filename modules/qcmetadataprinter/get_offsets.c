...
//    PRINT(CAM_INTF_META_LENS_FOCUS_STATE,             pMetadata); //Build error. Not found
    ...
    PRINT(CAM_INTF_META_DAEMON_RESTART,               pMetadata);
    PRINT(CAM_INTF_META_HYBRID_AE,                    pMetadata);
    PRINT(CAM_INTF_META_ISP_DIGITAL_GAIN,             pMetadata);
